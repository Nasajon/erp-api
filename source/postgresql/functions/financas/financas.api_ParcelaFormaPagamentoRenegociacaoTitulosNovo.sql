CREATE OR REPLACE FUNCTION financas.api_ParcelaFormaPagamentoRenegociacaoTitulosNovo(a_objeto financas.TParcelaFormaPagamentoRenegociacaoTitulosNovo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
