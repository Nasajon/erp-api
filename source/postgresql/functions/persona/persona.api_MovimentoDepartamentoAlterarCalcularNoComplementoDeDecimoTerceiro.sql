CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNoComplementoDeDecimoTerceiro(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNoComplementoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
