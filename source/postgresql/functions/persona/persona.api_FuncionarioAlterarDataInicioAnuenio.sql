CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDataInicioAnuenio(a_objeto persona.TFuncionarioAlterarDataInicioAnuenio) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
