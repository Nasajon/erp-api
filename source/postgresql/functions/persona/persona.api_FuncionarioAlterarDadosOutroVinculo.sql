CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosOutroVinculo(a_objeto persona.TFuncionarioAlterarDadosOutroVinculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
