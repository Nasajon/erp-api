CREATE OR REPLACE FUNCTION persona.api_LotacaoAlterarEnderecoDiferenteDoVinculo(a_objeto persona.TLotacaoAlterarEnderecoDiferenteDoVinculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
