CREATE OR REPLACE FUNCTION persona.api_EstagiarioAlterarDadosCarteiraTrabalho(a_objeto persona.TEstagiarioAlterarDadosCarteiraTrabalho) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
