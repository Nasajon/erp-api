CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarPeriodoEntreMesAno(a_objeto persona.TMovimentoFuncionarioAlterarPeriodoEntreMesAno) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
