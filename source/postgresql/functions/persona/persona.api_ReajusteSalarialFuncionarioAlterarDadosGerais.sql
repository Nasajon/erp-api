CREATE OR REPLACE FUNCTION persona.api_ReajusteSalarialFuncionarioAlterarDadosGerais(a_objeto persona.TReajusteSalarialFuncionarioAlterarDadosGerais) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
