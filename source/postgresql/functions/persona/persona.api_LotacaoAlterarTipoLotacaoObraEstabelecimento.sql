CREATE OR REPLACE FUNCTION persona.api_LotacaoAlterarTipoLotacaoObraEstabelecimento(a_objeto persona.TLotacaoAlterarTipoLotacaoObraEstabelecimento) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
