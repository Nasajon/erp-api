CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosProcessoIRRF(a_objeto persona.TFuncionarioAlterarDadosProcessoIRRF) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
