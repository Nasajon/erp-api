CREATE OR REPLACE FUNCTION persona.api_TarifaValeTransporteFuncionarioExcluir(a_objeto persona.TTarifaValeTransporteFuncionarioExcluir) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
