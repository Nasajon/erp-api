CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNaFolha(a_objeto persona.TMovimentoSindicatoAlterarCalcularNaFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
