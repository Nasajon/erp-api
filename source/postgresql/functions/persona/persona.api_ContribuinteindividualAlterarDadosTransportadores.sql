CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosTransportadores(a_objeto persona.TContribuinteindividualAlterarDadosTransportadores) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
