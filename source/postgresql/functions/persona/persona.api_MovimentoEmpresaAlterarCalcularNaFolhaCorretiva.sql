CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarCalcularNaFolhaCorretiva(a_objeto persona.TMovimentoEmpresaAlterarCalcularNaFolhaCorretiva) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
