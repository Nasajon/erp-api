CREATE OR REPLACE FUNCTION persona.api_RubricaAlterarValorIntegralBaseValorHora(a_objeto persona.TRubricaAlterarValorIntegralBaseValorHora) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
