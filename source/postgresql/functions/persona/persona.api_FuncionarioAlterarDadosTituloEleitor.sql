CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosTituloEleitor(a_objeto persona.TFuncionarioAlterarDadosTituloEleitor) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
