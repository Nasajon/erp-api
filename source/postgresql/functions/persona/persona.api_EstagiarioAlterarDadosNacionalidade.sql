CREATE OR REPLACE FUNCTION persona.api_EstagiarioAlterarDadosNacionalidade(a_objeto persona.TEstagiarioAlterarDadosNacionalidade) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
