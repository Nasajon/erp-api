CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosRIC(a_objeto persona.TContribuinteindividualAlterarDadosRIC) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
