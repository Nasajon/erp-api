CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarAcordoProrrogacao(a_objeto persona.TFuncionarioAlterarAcordoProrrogacao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
