CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNasFerias(a_objeto persona.TMovimentoSindicatoAlterarCalcularNasFerias) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
