CREATE OR REPLACE FUNCTION persona.api_DependenteFuncionarioAlterarBeneficiarioSalarioFamilia(a_objeto persona.TDependenteFuncionarioAlterarBeneficiarioSalarioFamilia) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
