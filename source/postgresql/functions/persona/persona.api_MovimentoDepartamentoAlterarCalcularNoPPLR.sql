CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNoPPLR(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNoPPLR) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
