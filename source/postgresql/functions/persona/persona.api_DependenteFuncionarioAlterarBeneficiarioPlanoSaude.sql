CREATE OR REPLACE FUNCTION persona.api_DependenteFuncionarioAlterarBeneficiarioPlanoSaude(a_objeto persona.TDependenteFuncionarioAlterarBeneficiarioPlanoSaude) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
