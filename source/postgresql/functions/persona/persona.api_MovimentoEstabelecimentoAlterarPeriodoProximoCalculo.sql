CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarPeriodoProximoCalculo(a_objeto persona.TMovimentoEstabelecimentoAlterarPeriodoProximoCalculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
