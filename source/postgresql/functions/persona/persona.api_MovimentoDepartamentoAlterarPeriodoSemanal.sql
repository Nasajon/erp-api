CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarPeriodoSemanal(a_objeto persona.TMovimentoDepartamentoAlterarPeriodoSemanal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
