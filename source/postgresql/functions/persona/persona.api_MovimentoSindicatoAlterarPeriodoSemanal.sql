CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarPeriodoSemanal(a_objeto persona.TMovimentoSindicatoAlterarPeriodoSemanal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
