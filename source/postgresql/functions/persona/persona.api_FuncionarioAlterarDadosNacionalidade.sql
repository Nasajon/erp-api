CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosNacionalidade(a_objeto persona.TFuncionarioAlterarDadosNacionalidade) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
