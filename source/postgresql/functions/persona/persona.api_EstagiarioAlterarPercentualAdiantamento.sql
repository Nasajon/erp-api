CREATE OR REPLACE FUNCTION persona.api_EstagiarioAlterarPercentualAdiantamento(a_objeto persona.TEstagiarioAlterarPercentualAdiantamento) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
