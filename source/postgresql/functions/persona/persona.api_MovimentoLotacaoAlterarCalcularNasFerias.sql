CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNasFerias(a_objeto persona.TMovimentoLotacaoAlterarCalcularNasFerias) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
