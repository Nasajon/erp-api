CREATE OR REPLACE FUNCTION persona.api_RubricaAlterarValorIntegralBaseValorDia(a_objeto persona.TRubricaAlterarValorIntegralBaseValorDia) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
