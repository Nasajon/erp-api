CREATE OR REPLACE FUNCTION persona.api_SindicatoAlterarDadosOutrasEntidades(a_objeto persona.TSindicatoAlterarDadosOutrasEntidades) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
