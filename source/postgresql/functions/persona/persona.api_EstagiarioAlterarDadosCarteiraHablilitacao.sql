CREATE OR REPLACE FUNCTION persona.api_EstagiarioAlterarDadosCarteiraHablilitacao(a_objeto persona.TEstagiarioAlterarDadosCarteiraHablilitacao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
