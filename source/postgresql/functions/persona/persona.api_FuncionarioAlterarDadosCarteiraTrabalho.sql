CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosCarteiraTrabalho(a_objeto persona.TFuncionarioAlterarDadosCarteiraTrabalho) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
