CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarPeriodoSempre(a_objeto persona.TMovimentoFuncionarioAlterarPeriodoSempre) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
