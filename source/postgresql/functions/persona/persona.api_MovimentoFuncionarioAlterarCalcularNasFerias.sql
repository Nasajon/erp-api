CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNasFerias(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNasFerias) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
