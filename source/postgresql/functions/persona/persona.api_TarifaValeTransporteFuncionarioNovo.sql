CREATE OR REPLACE FUNCTION persona.api_TarifaValeTransporteFuncionarioNovo(a_objeto persona.TTarifaValeTransporteFuncionarioNovo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
