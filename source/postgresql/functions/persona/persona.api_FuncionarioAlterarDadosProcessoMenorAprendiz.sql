CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosProcessoMenorAprendiz(a_objeto persona.TFuncionarioAlterarDadosProcessoMenorAprendiz) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
