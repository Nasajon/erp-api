CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarCalcularNaFolha(a_objeto persona.TMovimentoEmpresaAlterarCalcularNaFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
