CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarPeriodoMensal(a_objeto persona.TMovimentoFuncionarioAlterarPeriodoMensal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
