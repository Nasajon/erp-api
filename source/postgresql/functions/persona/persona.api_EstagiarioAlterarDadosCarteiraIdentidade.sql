CREATE OR REPLACE FUNCTION persona.api_EstagiarioAlterarDadosCarteiraIdentidade(a_objeto persona.TEstagiarioAlterarDadosCarteiraIdentidade) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
