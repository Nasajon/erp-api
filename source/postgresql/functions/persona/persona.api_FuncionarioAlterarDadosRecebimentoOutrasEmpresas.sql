CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosRecebimentoOutrasEmpresas(a_objeto persona.TFuncionarioAlterarDadosRecebimentoOutrasEmpresas) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
