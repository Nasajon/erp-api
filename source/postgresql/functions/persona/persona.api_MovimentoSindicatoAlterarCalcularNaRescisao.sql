CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNaRescisao(a_objeto persona.TMovimentoSindicatoAlterarCalcularNaRescisao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
