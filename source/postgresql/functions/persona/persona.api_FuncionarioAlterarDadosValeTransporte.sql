CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosValeTransporte(a_objeto persona.TFuncionarioAlterarDadosValeTransporte) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
