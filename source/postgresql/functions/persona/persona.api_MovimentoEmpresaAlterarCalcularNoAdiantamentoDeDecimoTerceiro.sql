CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarCalcularNoAdiantamentoDeDecimoTerceiro(a_objeto persona.TMovimentoEmpresaAlterarCalcularNoAdiantamentoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
