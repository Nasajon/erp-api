CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNoPPLR(a_objeto persona.TMovimentoSindicatoAlterarCalcularNoPPLR) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
