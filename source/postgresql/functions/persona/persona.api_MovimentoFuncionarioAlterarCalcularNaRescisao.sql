CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNaRescisao(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNaRescisao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
