CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarCalcularNasFerias(a_objeto persona.TMovimentoEstabelecimentoAlterarCalcularNasFerias) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
