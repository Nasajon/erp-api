CREATE OR REPLACE FUNCTION persona.api_SindicatoAlterarDadosCalculoRescisao(a_objeto persona.TSindicatoAlterarDadosCalculoRescisao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
...
BEGIN      
  BEGIN
	...
	IF (a_objeto.DiasAvisoPrevio IS NULL) THEN
      VAR_RETURN.MENSAGEM := ns.api_montamensagemerro('W0001#O campo "DiasAvisoPrevio" não pode ser nulo.');
	  RETURN VAR_RETURN;
	END IF;
