CREATE OR REPLACE FUNCTION persona.api_EscalaFolgaFuncionarioAlterar(a_objeto persona.TEscalaFolgaFuncionarioAlterar) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
...
BEGIN      
  BEGIN
	...
	IF (a_objeto.IdEscalaFolga IS NULL) THEN
      VAR_RETURN.MENSAGEM := ns.api_montamensagemerro('W0001#O campo "IdEscalaFolga" não pode ser nulo.');
	  RETURN VAR_RETURN;
	END IF;
