CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNoDecimoTerceiro(a_objeto persona.TMovimentoSindicatoAlterarCalcularNoDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
