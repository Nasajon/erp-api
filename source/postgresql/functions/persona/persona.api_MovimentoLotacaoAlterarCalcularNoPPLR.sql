CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNoPPLR(a_objeto persona.TMovimentoLotacaoAlterarCalcularNoPPLR) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
