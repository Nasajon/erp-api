CREATE OR REPLACE FUNCTION persona.api_DependenteFuncionarioAlterarBeneficiarioImpostoRenda(a_objeto persona.TDependenteFuncionarioAlterarBeneficiarioImpostoRenda) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
