CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarCalcularNoComplementoDeDecimoTerceiro(a_objeto persona.TMovimentoEmpresaAlterarCalcularNoComplementoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
