CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNoAdiantamento13(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNoAdiantamento13) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
