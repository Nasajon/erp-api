CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosNascimento(a_objeto persona.TContribuinteindividualAlterarDadosNascimento) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
