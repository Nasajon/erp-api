CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosEstrangeiro(a_objeto persona.TContribuinteindividualAlterarDadosEstrangeiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
