CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNoAdiantamentoDeFolha(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNoAdiantamentoDeFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
