CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarPeriodoEntreMesAno(a_objeto persona.TMovimentoSindicatoAlterarPeriodoEntreMesAno) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
