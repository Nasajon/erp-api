CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNaFolha(a_objeto persona.TMovimentoLotacaoAlterarCalcularNaFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
