CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarPeriodoMensal(a_objeto persona.TMovimentoEmpresaAlterarPeriodoMensal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
