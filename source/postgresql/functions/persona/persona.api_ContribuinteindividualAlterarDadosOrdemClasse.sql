CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosOrdemClasse(a_objeto persona.TContribuinteindividualAlterarDadosOrdemClasse) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
