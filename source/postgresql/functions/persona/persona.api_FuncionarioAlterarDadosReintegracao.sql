CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosReintegracao(a_objeto persona.TFuncionarioAlterarDadosReintegracao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
