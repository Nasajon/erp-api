CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarCalcularNaFolhaCorretiva(a_objeto persona.TMovimentoEstabelecimentoAlterarCalcularNaFolhaCorretiva) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
