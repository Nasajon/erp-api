CREATE OR REPLACE FUNCTION persona.api_DependenteFuncionarioAlterarDataBaixaImpostoRenda(a_objeto persona.TDependenteFuncionarioAlterarDataBaixaImpostoRenda) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
