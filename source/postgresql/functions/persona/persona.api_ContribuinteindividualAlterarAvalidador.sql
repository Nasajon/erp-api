CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarAvalidador(a_objeto persona.TContribuinteindividualAlterarAvalidador) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
