CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNoAdiantamentoDeDecimoTerceiro(a_objeto persona.TMovimentoLotacaoAlterarCalcularNoAdiantamentoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
