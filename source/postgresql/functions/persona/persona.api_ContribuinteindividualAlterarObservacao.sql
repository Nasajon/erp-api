CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarObservacao(a_objeto persona.TContribuinteindividualAlterarObservacao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
