CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarPeriodoMensal(a_objeto persona.TMovimentoDepartamentoAlterarPeriodoMensal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
