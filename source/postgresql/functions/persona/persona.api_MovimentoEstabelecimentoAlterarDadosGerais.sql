CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarDadosGerais(a_objeto persona.TMovimentoEstabelecimentoAlterarDadosGerais) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
