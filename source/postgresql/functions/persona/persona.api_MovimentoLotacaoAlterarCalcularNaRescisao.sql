CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNaRescisao(a_objeto persona.TMovimentoLotacaoAlterarCalcularNaRescisao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
