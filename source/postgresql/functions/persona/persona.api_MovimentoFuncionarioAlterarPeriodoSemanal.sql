CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarPeriodoSemanal(a_objeto persona.TMovimentoFuncionarioAlterarPeriodoSemanal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
