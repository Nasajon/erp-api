CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosRecebimentoSalario(a_objeto persona.TFuncionarioAlterarDadosRecebimentoSalario) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
