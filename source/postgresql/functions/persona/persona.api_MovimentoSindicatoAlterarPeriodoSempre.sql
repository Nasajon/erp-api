CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarPeriodoSempre(a_objeto persona.TMovimentoSindicatoAlterarPeriodoSempre) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
