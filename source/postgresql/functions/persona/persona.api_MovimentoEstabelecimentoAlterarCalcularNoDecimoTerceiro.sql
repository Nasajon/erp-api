CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarCalcularNoDecimoTerceiro(a_objeto persona.TMovimentoEstabelecimentoAlterarCalcularNoDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
