CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarMatriculaFuncionario(a_objeto persona.TContribuinteindividualAlterarMatriculaFuncionario) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
