CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarPeriodoEntreMesAno(a_objeto persona.TMovimentoEmpresaAlterarPeriodoEntreMesAno) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
