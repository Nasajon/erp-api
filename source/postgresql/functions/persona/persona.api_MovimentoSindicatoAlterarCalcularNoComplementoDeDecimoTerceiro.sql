CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNoComplementoDeDecimoTerceiro(a_objeto persona.TMovimentoSindicatoAlterarCalcularNoComplementoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
