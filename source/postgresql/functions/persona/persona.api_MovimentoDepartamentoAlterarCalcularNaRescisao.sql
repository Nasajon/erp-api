CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNaRescisao(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNaRescisao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
