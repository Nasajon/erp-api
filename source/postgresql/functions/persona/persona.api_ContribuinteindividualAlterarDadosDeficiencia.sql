CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosDeficiencia(a_objeto persona.TContribuinteindividualAlterarDadosDeficiencia) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
