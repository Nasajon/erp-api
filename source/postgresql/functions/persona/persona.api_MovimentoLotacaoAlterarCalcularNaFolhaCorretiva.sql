CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNaFolhaCorretiva(a_objeto persona.TMovimentoLotacaoAlterarCalcularNaFolhaCorretiva) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
