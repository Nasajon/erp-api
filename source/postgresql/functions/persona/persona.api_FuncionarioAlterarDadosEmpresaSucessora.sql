CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosEmpresaSucessora(a_objeto persona.TFuncionarioAlterarDadosEmpresaSucessora) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
