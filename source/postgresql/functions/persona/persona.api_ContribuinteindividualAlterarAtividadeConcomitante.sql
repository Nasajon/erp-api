CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarAtividadeConcomitante(a_objeto persona.TContribuinteindividualAlterarAtividadeConcomitante) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
