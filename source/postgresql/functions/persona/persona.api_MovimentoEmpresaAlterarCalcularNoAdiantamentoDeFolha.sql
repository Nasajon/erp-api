CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarCalcularNoAdiantamentoDeFolha(a_objeto persona.TMovimentoEmpresaAlterarCalcularNoAdiantamentoDeFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
