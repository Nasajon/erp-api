CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNoAdiantamentoDeFolha(a_objeto persona.TMovimentoSindicatoAlterarCalcularNoAdiantamentoDeFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
