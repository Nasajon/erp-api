CREATE OR REPLACE FUNCTION persona.api_RubricaAlterarValorIntegralBaseSindical(a_objeto persona.TRubricaAlterarValorIntegralBaseSindical) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
