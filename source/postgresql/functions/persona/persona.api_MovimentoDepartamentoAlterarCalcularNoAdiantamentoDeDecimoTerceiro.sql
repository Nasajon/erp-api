CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNoAdiantamentoDeDecimoTerceiro(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNoAdiantamentoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
