CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNoDecimoTerceiro(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNoDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
