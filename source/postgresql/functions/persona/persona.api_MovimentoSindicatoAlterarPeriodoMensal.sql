CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarPeriodoMensal(a_objeto persona.TMovimentoSindicatoAlterarPeriodoMensal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
