CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNaFolha(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNaFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
