CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarPeriodoSempre(a_objeto persona.TMovimentoDepartamentoAlterarPeriodoSempre) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
