CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarAtividadeConcomitante(a_objeto persona.TFuncionarioAlterarAtividadeConcomitante) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
