CREATE OR REPLACE FUNCTION persona.api_LotacaoAlterarTipoLotacaoEstabelecimento(a_objeto persona.TLotacaoAlterarTipoLotacaoEstabelecimento) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
