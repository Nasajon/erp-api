CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarPeriodoSemanal(a_objeto persona.TMovimentoEmpresaAlterarPeriodoSemanal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
