CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosEmpresaCedente(a_objeto persona.TFuncionarioAlterarDadosEmpresaCedente) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
