CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarPeriodoEntreDatas(a_objeto persona.TMovimentoFuncionarioAlterarPeriodoEntreDatas) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
