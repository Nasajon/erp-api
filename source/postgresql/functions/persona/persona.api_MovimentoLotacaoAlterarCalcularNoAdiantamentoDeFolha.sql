CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNoAdiantamentoDeFolha(a_objeto persona.TMovimentoLotacaoAlterarCalcularNoAdiantamentoDeFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
