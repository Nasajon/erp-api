CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarPeriodoProximoCalculo(a_objeto persona.TMovimentoEmpresaAlterarPeriodoProximoCalculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
