CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarCalcularNaRescisao(a_objeto persona.TMovimentoEstabelecimentoAlterarCalcularNaRescisao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
