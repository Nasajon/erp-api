CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosCarteiraTrabalho(a_objeto persona.TContribuinteindividualAlterarDadosCarteiraTrabalho) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
