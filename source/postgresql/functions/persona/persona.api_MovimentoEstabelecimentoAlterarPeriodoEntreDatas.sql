CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarPeriodoEntreDatas(a_objeto persona.TMovimentoEstabelecimentoAlterarPeriodoEntreDatas) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
