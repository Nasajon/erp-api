CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarPeriodoSempre(a_objeto persona.TMovimentoLotacaoAlterarPeriodoSempre) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
