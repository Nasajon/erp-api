CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarCalcularNasFerias(a_objeto persona.TMovimentoEmpresaAlterarCalcularNasFerias) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
