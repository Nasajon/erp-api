CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosCarteiraHablilitacao(a_objeto persona.TContribuinteindividualAlterarDadosCarteiraHablilitacao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
