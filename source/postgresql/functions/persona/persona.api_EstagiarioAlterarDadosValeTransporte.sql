CREATE OR REPLACE FUNCTION persona.api_EstagiarioAlterarDadosValeTransporte(a_objeto persona.TEstagiarioAlterarDadosValeTransporte) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
