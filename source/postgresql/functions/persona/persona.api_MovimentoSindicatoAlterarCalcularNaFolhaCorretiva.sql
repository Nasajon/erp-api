CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNaFolhaCorretiva(a_objeto persona.TMovimentoSindicatoAlterarCalcularNaFolhaCorretiva) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
