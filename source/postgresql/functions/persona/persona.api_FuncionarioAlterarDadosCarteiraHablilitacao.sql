CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosCarteiraHablilitacao(a_objeto persona.TFuncionarioAlterarDadosCarteiraHablilitacao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
