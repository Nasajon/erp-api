CREATE OR REPLACE FUNCTION persona.api_ConcessionariaValeTransporteAlterar(a_objeto persona.TConcessionariaValeTransporteAlterar) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
