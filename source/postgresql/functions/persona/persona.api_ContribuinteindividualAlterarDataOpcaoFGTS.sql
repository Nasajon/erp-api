CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDataOpcaoFGTS(a_objeto persona.TContribuinteindividualAlterarDataOpcaoFGTS) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
