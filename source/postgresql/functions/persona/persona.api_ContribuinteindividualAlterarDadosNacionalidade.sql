CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosNacionalidade(a_objeto persona.TContribuinteindividualAlterarDadosNacionalidade) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
