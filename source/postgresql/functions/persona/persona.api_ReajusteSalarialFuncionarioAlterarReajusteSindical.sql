CREATE OR REPLACE FUNCTION persona.api_ReajusteSalarialFuncionarioAlterarReajusteSindical(a_objeto persona.TReajusteSalarialFuncionarioAlterarReajusteSindical) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
...
BEGIN      
  BEGIN
	...
	IF (a_objeto.DataReajusteSindical IS NULL) THEN
      VAR_RETURN.MENSAGEM := ns.api_montamensagemerro('W0001#O campo "DataReajusteSindical" não pode ser nulo.');
	  RETURN VAR_RETURN;
	END IF;
