CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNoDecimoTerceiro(a_objeto persona.TMovimentoLotacaoAlterarCalcularNoDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
