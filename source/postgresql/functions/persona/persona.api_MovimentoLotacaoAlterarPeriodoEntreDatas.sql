CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarPeriodoEntreDatas(a_objeto persona.TMovimentoLotacaoAlterarPeriodoEntreDatas) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
