CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarCalcularNoAdiantamentoDeDecimoTerceiro(a_objeto persona.TMovimentoEstabelecimentoAlterarCalcularNoAdiantamentoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
