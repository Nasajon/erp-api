CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNoAdiantamentoDeFolha(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNoAdiantamentoDeFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
