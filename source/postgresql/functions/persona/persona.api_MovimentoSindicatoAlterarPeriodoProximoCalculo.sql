CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarPeriodoProximoCalculo(a_objeto persona.TMovimentoSindicatoAlterarPeriodoProximoCalculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
