CREATE OR REPLACE FUNCTION persona.api_EstagiarioAlterarDataVencimentoAtestadoMedico(a_objeto persona.TEstagiarioAlterarDataVencimentoAtestadoMedico) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
