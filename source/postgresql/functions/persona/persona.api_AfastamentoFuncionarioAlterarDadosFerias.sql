CREATE OR REPLACE FUNCTION persona.api_AfastamentoFuncionarioAlterarDadosFerias(a_objeto persona.TAfastamentoFuncionarioAlterarDadosFerias) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
