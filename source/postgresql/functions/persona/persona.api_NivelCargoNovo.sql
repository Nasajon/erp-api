CREATE OR REPLACE FUNCTION persona.api_NivelCargoNovo(a_objeto persona.TNivelCargoNovo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
...
BEGIN      
  BEGIN
	...
	IF (a_objeto.IdNivel IS NULL) THEN
      VAR_RETURN.MENSAGEM := ns.api_montamensagemerro('W0001#O campo "IdNivel" não pode ser nulo.');
	  RETURN VAR_RETURN;
	END IF;
