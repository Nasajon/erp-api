CREATE OR REPLACE FUNCTION persona.api_AfastamentoFuncionarioAlterarDadosCessao(a_objeto persona.TAfastamentoFuncionarioAlterarDadosCessao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
