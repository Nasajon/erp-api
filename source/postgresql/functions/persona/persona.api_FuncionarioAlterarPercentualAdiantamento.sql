CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarPercentualAdiantamento(a_objeto persona.TFuncionarioAlterarPercentualAdiantamento) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
