CREATE OR REPLACE FUNCTION persona.api_RubricaAlterarValorIntegralBaseSalarioFamilia(a_objeto persona.TRubricaAlterarValorIntegralBaseSalarioFamilia) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
