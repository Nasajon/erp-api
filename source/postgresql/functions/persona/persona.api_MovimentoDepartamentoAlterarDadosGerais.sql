CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarDadosGerais(a_objeto persona.TMovimentoDepartamentoAlterarDadosGerais) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
