CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarPeriodoEntreDatas(a_objeto persona.TMovimentoEmpresaAlterarPeriodoEntreDatas) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
