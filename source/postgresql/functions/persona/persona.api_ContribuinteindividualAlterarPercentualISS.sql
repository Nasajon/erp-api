CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarPercentualISS(a_objeto persona.TContribuinteindividualAlterarPercentualISS) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
