CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNoPPLR(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNoPPLR) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
