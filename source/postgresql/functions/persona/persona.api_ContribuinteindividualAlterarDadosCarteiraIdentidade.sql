CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosCarteiraIdentidade(a_objeto persona.TContribuinteindividualAlterarDadosCarteiraIdentidade) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
