CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarCalcularNoPPLR(a_objeto persona.TMovimentoEmpresaAlterarCalcularNoPPLR) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
