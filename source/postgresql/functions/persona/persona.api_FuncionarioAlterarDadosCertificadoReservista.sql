CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosCertificadoReservista(a_objeto persona.TFuncionarioAlterarDadosCertificadoReservista) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
