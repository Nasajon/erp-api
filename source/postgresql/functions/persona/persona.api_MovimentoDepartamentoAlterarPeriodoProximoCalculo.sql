CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarPeriodoProximoCalculo(a_objeto persona.TMovimentoDepartamentoAlterarPeriodoProximoCalculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
