CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarCalcularNoComplementoDeDecimoTerceiro(a_objeto persona.TMovimentoEstabelecimentoAlterarCalcularNoComplementoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
