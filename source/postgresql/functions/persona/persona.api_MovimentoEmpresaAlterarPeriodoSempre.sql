CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarPeriodoSempre(a_objeto persona.TMovimentoEmpresaAlterarPeriodoSempre) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
