CREATE OR REPLACE FUNCTION persona.api_MovimentoEmpresaAlterarCalcularNoDecimoTerceiro(a_objeto persona.TMovimentoEmpresaAlterarCalcularNoDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
