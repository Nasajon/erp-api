CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNoComplemento13(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNoComplemento13) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
