CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarCalcularNoComplementoDeDecimoTerceiro(a_objeto persona.TMovimentoLotacaoAlterarCalcularNoComplementoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
