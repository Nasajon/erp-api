CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNaFolhaCorretiva(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNaFolhaCorretiva) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
