CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarPeriodoEntreMesAno(a_objeto persona.TMovimentoDepartamentoAlterarPeriodoEntreMesAno) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
