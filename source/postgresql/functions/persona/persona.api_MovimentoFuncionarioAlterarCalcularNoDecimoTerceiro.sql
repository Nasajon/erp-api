CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNoDecimoTerceiro(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNoDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
