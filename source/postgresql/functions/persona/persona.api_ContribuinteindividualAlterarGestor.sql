CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarGestor(a_objeto persona.TContribuinteindividualAlterarGestor) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
