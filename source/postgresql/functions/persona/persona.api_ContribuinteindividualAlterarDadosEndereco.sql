CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosEndereco(a_objeto persona.TContribuinteindividualAlterarDadosEndereco) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
