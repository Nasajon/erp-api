CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarPeriodoSemanal(a_objeto persona.TMovimentoLotacaoAlterarPeriodoSemanal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
