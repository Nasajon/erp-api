CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarPeriodoEntreMesAno(a_objeto persona.TMovimentoEstabelecimentoAlterarPeriodoEntreMesAno) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
