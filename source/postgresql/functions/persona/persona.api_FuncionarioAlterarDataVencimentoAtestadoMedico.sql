CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDataVencimentoAtestadoMedico(a_objeto persona.TFuncionarioAlterarDataVencimentoAtestadoMedico) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
