CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarPeriodoEntreDatas(a_objeto persona.TMovimentoSindicatoAlterarPeriodoEntreDatas) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
