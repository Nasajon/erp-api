CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarMatriculaContribuinteIndividual(a_objeto persona.TFuncionarioAlterarMatriculaContribuinteIndividual) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
