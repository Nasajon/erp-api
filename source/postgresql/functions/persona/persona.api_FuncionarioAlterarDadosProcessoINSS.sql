CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosProcessoINSS(a_objeto persona.TFuncionarioAlterarDadosProcessoINSS) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
