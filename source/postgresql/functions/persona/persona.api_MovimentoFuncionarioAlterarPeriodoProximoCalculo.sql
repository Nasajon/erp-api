CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarPeriodoProximoCalculo(a_objeto persona.TMovimentoFuncionarioAlterarPeriodoProximoCalculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
