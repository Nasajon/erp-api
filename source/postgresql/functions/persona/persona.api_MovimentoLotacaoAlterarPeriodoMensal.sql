CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarPeriodoMensal(a_objeto persona.TMovimentoLotacaoAlterarPeriodoMensal) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
