CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNaFolhaCorretiva(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNaFolhaCorretiva) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
