CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarIdentidadeNasajon(a_objeto persona.TFuncionarioAlterarIdentidadeNasajon) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
