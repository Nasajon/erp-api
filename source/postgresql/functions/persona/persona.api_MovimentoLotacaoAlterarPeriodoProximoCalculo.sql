CREATE OR REPLACE FUNCTION persona.api_MovimentoLotacaoAlterarPeriodoProximoCalculo(a_objeto persona.TMovimentoLotacaoAlterarPeriodoProximoCalculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
