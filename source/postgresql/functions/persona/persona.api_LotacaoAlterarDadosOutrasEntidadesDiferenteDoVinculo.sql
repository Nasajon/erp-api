CREATE OR REPLACE FUNCTION persona.api_LotacaoAlterarDadosOutrasEntidadesDiferenteDoVinculo(a_objeto persona.TLotacaoAlterarDadosOutrasEntidadesDiferenteDoVinculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
