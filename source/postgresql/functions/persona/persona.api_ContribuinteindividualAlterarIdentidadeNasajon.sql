CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarIdentidadeNasajon(a_objeto persona.TContribuinteindividualAlterarIdentidadeNasajon) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
