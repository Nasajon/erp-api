CREATE OR REPLACE FUNCTION persona.api_MovimentoFuncionarioAlterarCalcularNaFolha(a_objeto persona.TMovimentoFuncionarioAlterarCalcularNaFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
