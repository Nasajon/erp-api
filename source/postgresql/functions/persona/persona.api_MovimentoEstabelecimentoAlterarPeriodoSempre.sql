CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarPeriodoSempre(a_objeto persona.TMovimentoEstabelecimentoAlterarPeriodoSempre) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
