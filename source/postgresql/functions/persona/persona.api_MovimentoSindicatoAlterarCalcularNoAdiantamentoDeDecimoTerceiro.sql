CREATE OR REPLACE FUNCTION persona.api_MovimentoSindicatoAlterarCalcularNoAdiantamentoDeDecimoTerceiro(a_objeto persona.TMovimentoSindicatoAlterarCalcularNoAdiantamentoDeDecimoTerceiro) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
