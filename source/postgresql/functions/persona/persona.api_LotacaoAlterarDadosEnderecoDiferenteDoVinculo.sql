CREATE OR REPLACE FUNCTION persona.api_LotacaoAlterarDadosEnderecoDiferenteDoVinculo(a_objeto persona.TLotacaoAlterarDadosEnderecoDiferenteDoVinculo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
