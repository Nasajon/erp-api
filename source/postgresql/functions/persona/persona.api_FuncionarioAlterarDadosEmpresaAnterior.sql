CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosEmpresaAnterior(a_objeto persona.TFuncionarioAlterarDadosEmpresaAnterior) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
