CREATE OR REPLACE FUNCTION persona.api_MovimentoDepartamentoAlterarCalcularNasFerias(a_objeto persona.TMovimentoDepartamentoAlterarCalcularNasFerias) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
