CREATE OR REPLACE FUNCTION persona.api_FuncionarioAlterarDadosCarteiraIdentidade(a_objeto persona.TFuncionarioAlterarDadosCarteiraIdentidade) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
