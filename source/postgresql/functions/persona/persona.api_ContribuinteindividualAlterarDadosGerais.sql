CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosGerais(a_objeto persona.TContribuinteindividualAlterarDadosGerais) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
