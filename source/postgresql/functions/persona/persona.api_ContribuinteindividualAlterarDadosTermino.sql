CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosTermino(a_objeto persona.TContribuinteindividualAlterarDadosTermino) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
