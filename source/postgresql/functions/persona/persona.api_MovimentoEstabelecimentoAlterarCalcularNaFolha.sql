CREATE OR REPLACE FUNCTION persona.api_MovimentoEstabelecimentoAlterarCalcularNaFolha(a_objeto persona.TMovimentoEstabelecimentoAlterarCalcularNaFolha) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
