CREATE OR REPLACE FUNCTION persona.api_ContribuinteindividualAlterarDadosRecebimentoSalario(a_objeto persona.TContribuinteindividualAlterarDadosRecebimentoSalario) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
