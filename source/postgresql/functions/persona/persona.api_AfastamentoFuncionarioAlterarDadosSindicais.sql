CREATE OR REPLACE FUNCTION persona.api_AfastamentoFuncionarioAlterarDadosSindicais(a_objeto persona.TAfastamentoFuncionarioAlterarDadosSindicais) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
