CREATE OR REPLACE FUNCTION persona.api_AfastamentoFuncionarioAlterarDadosMedicos(a_objeto persona.TAfastamentoFuncionarioAlterarDadosMedicos) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
