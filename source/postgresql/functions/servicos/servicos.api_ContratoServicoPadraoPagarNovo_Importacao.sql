CREATE OR REPLACE FUNCTION servicos.api_ContratoServicoPadraoPagarNovo_Importacao(a_objeto servicos.TContratoServicoPadraoPagarNovo_Importacao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
