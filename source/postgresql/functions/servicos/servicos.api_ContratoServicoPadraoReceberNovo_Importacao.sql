CREATE OR REPLACE FUNCTION servicos.api_ContratoServicoPadraoReceberNovo_Importacao(a_objeto servicos.TContratoServicoPadraoReceberNovo_Importacao) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
