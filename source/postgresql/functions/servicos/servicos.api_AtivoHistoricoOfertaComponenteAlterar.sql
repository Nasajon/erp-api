CREATE OR REPLACE FUNCTION servicos.api_AtivoHistoricoOfertaComponenteAlterar(a_objeto servicos.TAtivoHistoricoOfertaComponenteAlterar) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
