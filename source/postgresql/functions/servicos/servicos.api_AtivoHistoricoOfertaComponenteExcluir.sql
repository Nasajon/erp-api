CREATE OR REPLACE FUNCTION servicos.api_AtivoHistoricoOfertaComponenteExcluir(a_objeto servicos.TAtivoHistoricoOfertaComponenteExcluir) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
