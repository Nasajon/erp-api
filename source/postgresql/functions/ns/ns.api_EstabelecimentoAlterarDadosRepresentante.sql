CREATE OR REPLACE FUNCTION ns.api_EstabelecimentoAlterarDadosRepresentante(a_objeto ns.TEstabelecimentoAlterarDadosRepresentante) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
