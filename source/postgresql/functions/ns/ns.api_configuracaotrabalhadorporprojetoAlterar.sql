CREATE OR REPLACE FUNCTION ns.api_configuracaotrabalhadorporprojetoAlterar(a_objeto ns.TconfiguracaotrabalhadorporprojetoAlterar) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
