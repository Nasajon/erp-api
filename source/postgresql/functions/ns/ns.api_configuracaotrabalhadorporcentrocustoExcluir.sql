CREATE OR REPLACE FUNCTION ns.api_configuracaotrabalhadorporcentrocustoExcluir(a_objeto ns.TconfiguracaotrabalhadorporcentrocustoExcluir) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
