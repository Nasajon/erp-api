CREATE OR REPLACE FUNCTION ns.api_configuracaotrabalhadorporprojetoExcluir(a_objeto ns.TconfiguracaotrabalhadorporprojetoExcluir) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
