CREATE OR REPLACE FUNCTION ns.api_configuracaotrabalhadorporcentrocustoNovo(a_objeto ns.TconfiguracaotrabalhadorporcentrocustoNovo) RETURNS ns.TRecibo AS
$BODY$
DECLARE
  -- BEGIN DECLARE
