CREATE TYPE financas.TFormaPagamentoRenegociacaoTitulosNovo AS (
     Id uuid
   , id_renegociacaotitulos text
   ...
   , issretido numeric(13,2)
   , inssretido numeric(13,2)
   , id_documentorateado uuid
