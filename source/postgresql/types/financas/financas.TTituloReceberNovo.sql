CREATE TYPE financas.TTituloReceberNovo AS (
     Id uuid
   ...
   , valorvariacaocambialativa numeric(20,2)
   , valorvariacaocambialpassiva numeric(20,2)
   ...
   , Previsto boolean
   , id_documento_associado uuid
   , pagamento text
   , parcelapagamento text
   , adiantamentos financas.TAdiantamentoSaldo[]
   , TipoCredito integer
