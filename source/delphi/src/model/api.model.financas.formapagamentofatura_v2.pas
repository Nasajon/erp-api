unit api.model.financas.FormaPagamentoFatura_v2;
...
type TFormaPagamentoFatura_v2 = class(TInterfacedObject, IConteudoMensagemBroker, IConteudoMensagemBroker_API)

  strict private

    var m_FormaPagamentoFatura: String;
    ...
    function getFormaPagamentoFatura(): String;
    ...
    procedure setFormaPagamentoFatura(const a_Value: String);
  ...
  public
    ...
    [NasajonSerializeAttribute('formapagamentofatura')]
    property formapagamentofatura: String read getFormaPagamentoFatura write setFormaPagamentoFatura;
...
function TFormaPagamentoFatura_v2.getFormaPagamentoFatura: String;
begin
  Result := Self.m_FormaPagamentoFatura;
end;

procedure TFormaPagamentoFatura_v2.setFormaPagamentoFatura(const a_Value: String);
begin
  Self.m_FormaPagamentoFatura := a_Value;
end;

function TFormaPagamentoFatura_v2.getFormaPagamento: String;
begin
  Result := Self.m_FormaPagamento;
end;

procedure TFormaPagamentoFatura_v2.setFormaPagamento(const a_Value: String);
begin
  Self.m_FormaPagamento := a_Value;
end;

function TFormaPagamentoFatura_v2.getConta: String;
begin
  Result := Self.m_Conta;
end;

procedure TFormaPagamentoFatura_v2.setConta(const a_Value: String);
begin
  Self.m_Conta := a_Value;
end;

function TFormaPagamentoFatura_v2.getRateioPadrao: TRateioPadrao;
begin
...
procedure TFormaPagamentoFatura_v2.setRateioPadrao(const a_Value: TRateioPadrao);
begin
  Self.m_RateioPadrao := a_Value;
end;

function TFormaPagamentoFatura_v2.getMeioEletronicoCartao: String;
begin
  Result := Self.m_MeioEletronicoCartao;
end;

procedure TFormaPagamentoFatura_v2.setMeioEletronicoCartao(const a_Value: String);
begin
  Self.m_MeioEletronicoCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getLayoutCobranca: TLayoutCobranca;
begin
...
procedure TFormaPagamentoFatura_v2.setLayoutCobranca(const a_Value: TLayoutCobranca);
begin
  Self.m_LayoutCobranca := a_Value;
end;

function TFormaPagamentoFatura_v2.getOperadoraCartao: String;
begin
  Result := Self.m_OperadoraCartao;
end;

procedure TFormaPagamentoFatura_v2.setOperadoraCartao(const a_Value: String);
begin
  Self.m_OperadoraCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getBandeiraCartao: String;
begin
  Result := Self.m_BandeiraCartao;
end;

procedure TFormaPagamentoFatura_v2.setBandeiraCartao(const a_Value: String);
begin
  Self.m_BandeiraCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getParcelamento: String;
begin
  Result := Self.m_Parcelamento;
end;

procedure TFormaPagamentoFatura_v2.setParcelamento(const a_Value: String);
begin
  Self.m_Parcelamento := a_Value;
end;

function TFormaPagamentoFatura_v2.getValor: Currency;
begin
  Result := Self.m_Valor;
end;

procedure TFormaPagamentoFatura_v2.setValor(const a_Value: Currency);
begin
  Self.m_Valor := a_Value;
end;

function TFormaPagamentoFatura_v2.getNomeFormaPagamento: String;
begin
  Result := Self.m_NomeFormaPagamento;
end;

procedure TFormaPagamentoFatura_v2.setNomeFormaPagamento(const a_Value: String);
begin
  Self.m_NomeFormaPagamento := a_Value;
end;

function TFormaPagamentoFatura_v2.getNomeMeioEletronicoCartao: String;
begin
  Result := Self.m_NomeMeioEletronicoCartao;
end;

procedure TFormaPagamentoFatura_v2.setNomeMeioEletronicoCartao(const a_Value: String);
begin
  Self.m_NomeMeioEletronicoCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getNomeBandeiraCartao: String;
begin
  Result := Self.m_NomeBandeiraCartao;
end;

procedure TFormaPagamentoFatura_v2.setNomeBandeiraCartao(const a_Value: String);
begin
  Self.m_NomeBandeiraCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getNomeOperadoraCartao: String;
begin
  Result := Self.m_NomeOperadoraCartao;
end;

procedure TFormaPagamentoFatura_v2.setNomeOperadoraCartao(const a_Value: String);
begin
  Self.m_NomeOperadoraCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getNomeConta: String;
begin
  Result := Self.m_NomeConta;
end;

procedure TFormaPagamentoFatura_v2.setNomeConta(const a_Value: String);
begin
  Self.m_NomeConta := a_Value;
end;

function TFormaPagamentoFatura_v2.getNumeroParcelas: Integer;
begin
  Result := Self.m_NumeroParcelas;
end;

procedure TFormaPagamentoFatura_v2.setNumeroParcelas(const a_Value: Integer);
begin
  Self.m_NumeroParcelas := a_Value;
end;

function TFormaPagamentoFatura_v2.getDataFatura: TDate;
begin
  Result := Self.m_DataFatura;
end;

procedure TFormaPagamentoFatura_v2.setDataFatura(const a_Value: TDate);
begin
  Self.m_DataFatura := a_Value;
end;

function TFormaPagamentoFatura_v2.getTipoOperacao: Integer;
begin
  Result := Self.m_TipoOperacao;
end;

procedure TFormaPagamentoFatura_v2.setTipoOperacao(const a_Value: Integer);
begin
  Self.m_TipoOperacao := a_Value;
end;

function TFormaPagamentoFatura_v2.getAutorizacaoCartao: String;
begin
  Result := Self.m_AutorizacaoCartao;
end;

procedure TFormaPagamentoFatura_v2.setAutorizacaoCartao(const a_Value: String);
begin
  Self.m_AutorizacaoCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getDataAutorizacaoCartao: TDate;
begin
  Result := Self.m_DataAutorizacaoCartao;
end;

procedure TFormaPagamentoFatura_v2.setDataAutorizacaoCartao(const a_Value: TDate);
begin
  Self.m_DataAutorizacaoCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getDocumentoCartao: String;
begin
  Result := Self.m_DocumentoCartao;
end;

procedure TFormaPagamentoFatura_v2.setDocumentoCartao(const a_Value: String);
begin
  Self.m_DocumentoCartao := a_Value;
end;

function TFormaPagamentoFatura_v2.getIrRetido: Currency;
begin
  Result := Self.m_IrRetido;
end;

procedure TFormaPagamentoFatura_v2.setIrRetido(const a_Value: Currency);
begin
  Self.m_IrRetido := a_Value;
end;

function TFormaPagamentoFatura_v2.getPisRetido: Currency;
begin
  Result := Self.m_PisRetido;
end;

procedure TFormaPagamentoFatura_v2.setPisRetido(const a_Value: Currency);
begin
  Self.m_PisRetido := a_Value;
end;

function TFormaPagamentoFatura_v2.getCofinsRetido: Currency;
begin
  Result := Self.m_CofinsRetido;
end;

procedure TFormaPagamentoFatura_v2.setCofinsRetido(const a_Value: Currency);
begin
  Self.m_CofinsRetido := a_Value;
end;

function TFormaPagamentoFatura_v2.getCsllRetido: Currency;
begin
  Result := Self.m_CsllRetido;
end;

procedure TFormaPagamentoFatura_v2.setCsllRetido(const a_Value: Currency);
begin
  Self.m_CsllRetido := a_Value;
end;

destructor TFormaPagamentoFatura_v2.Destroy;
begin
  Self.RateioPadrao.Free();  Self.LayoutCobranca.Free();
end;

function TFormaPagamentoFatura_v2.getType(): String;
begin
  Result := BROKER_TYPE_MESSAGE_API;
end;

function TFormaPagamentoFatura_v2.getBody(): String;
begin
  Result := TBuildConteudoMensagemBroker.getInstance().BuildMensagem_API(Self);
end;

function TFormaPagamentoFatura_v2.getNameAPI(): String;
begin
  Result := 'FormaPagamentoFatura_v2';
end;

function TFormaPagamentoFatura_v2.getJSON(): TJSONObject;
begin
  Result := TJsonUtilGenerics.Marshal_To_JSONObject(Self);
end;

function TFormaPagamentoFatura_v2.execute(const a_Connection: TUniConnection): TRecibo;
begin
