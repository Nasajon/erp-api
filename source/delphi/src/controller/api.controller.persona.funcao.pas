unit api.controller.persona.Funcao;
...
begin
  Result := TDAO.callFunction('persona.api_FuncaoNovo', TUtils.MontaParametrosSQL(a_Objeto));
end;
...
begin
  Result := TDAO.callFunction('persona.api_FuncaoAlterar', TUtils.MontaParametrosSQL(a_Objeto));
end;
...
begin
  Result := TDAO.callFunction('persona.api_FuncaoExcluir', TUtils.MontaParametrosSQL(a_Objeto));
end;
